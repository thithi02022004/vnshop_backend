                                ...
                                <div id="myModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            ...
                                            <form class="row g-3" action="{{route('create_subdomain', ['token' => auth()->user()->refesh_token])}}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input name="icon_sub" type="file" class="form-control" id="validationDefault02" >
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="validationDefault01" class="form-label">Domain Chính</label>
                                                    <input name="main_domain" type="text" class="form-control" id="validationDefault01" value="vnshop.top" disabled>
                                                </div>
                                                <div class="col-md-12">
                                    ...
                                    <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-ordering="false">Sub domain</th>
                                                <th data-ordering="false">Domain chính</th>
                                                <th data-ordering="false">Icon sub</th>
                                                <!-- <th>Hành động</th> -->
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($subdomains as $subdomain)
                                                <tr>
                                                    ...
                                                    <td>{{$subdomain->main_domain}}</td>
                                                    <td class="col-2"><img class="col-4" src="{{$subdomain->icon_sub}}"></td>
                                                    <td>
                                                        <div class="dropdown d-inline-block">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item remove-item-btn" href="{{route('delete_subdomain', ['id' => $subdomain->id, 'token' => auth()->user()->refesh_token])}}">
