                    ...
                    <div class="col-xl-12">
                        <div class="card">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-body text-center p-5">
                                                <form action="<?php echo e(route('voucher_main.store', ['token' => auth()->user()->refesh_token])); ?>" method="POST" enctype="multipart/form-data">
                                                    <?php echo csrf_field(); ?>
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <div class="mb-3">
                            ...
                            <div class="card-body">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-6">
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <input type="text" class="form-control" id="title-<?php echo e($voucherMain->id); ?>" name="title"
                                                                                                    placeholder="Tiêu đề" value="<?php echo e(old('title', $voucherMain->title)); ?>" required
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <textarea class="form-control" id="description-<?php echo e($voucherMain->id); ?>" name="description"
                                                                                                    rows="2" placeholder="Nội dung" required
                                                                                                    title="Nội dung không được để trống."><?php echo e(old('description', $voucherMain->description)); ?></textarea>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-6">
                                                                                            <div class="mb-3">
                                                                                                <label for="quantity-<?php echo e($voucherMain->id); ?>" class="form-label">Số lượng</label>
                                                                                                <input type="number" class="form-control" id="quantity-<?php echo e($voucherMain->id); ?>" name="quantity"
                                                                                                    placeholder="Số lượng" min="1" value="<?php echo e(old('quantity', $voucherMain->quantity)); ?>" required
                                                                                                    title="Số lượng phải lớn hơn hoặc bằng 1.">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-6">
                                                                                            <div class="mb-3">
                                                                                                <label for="limitValue-<?php echo e($voucherMain->id); ?>" class="form-label">Số tiền tối đa được giảm</label>
                                                                                                <input type="number" class="form-control" id="limitValue-<?php echo e($voucherMain->id); ?>" name="limitValue"
                                                                                                    placeholder="Số tiền tối đa được giảm" min="1" value="<?php echo e(old('limitValue', $voucherMain->limitValue)); ?>" required
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <input type="number" class="form-control" id="ratio-<?php echo e($voucherMain->id); ?>" name="ratio" step="0.01"
                                                                                                    min="0" max="100" placeholder="Phần trăm giảm giá (0-100)" value="<?php echo e(old('ratio', $voucherMain->ratio)); ?>" required
                                                                                                    title="Phần trăm giảm giá phải nằm trong khoảng 0 đến 100.">
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-6">
                                                                                            <div class="mb-3">
                                                                                                <label for="min_order-<?php echo e($voucherMain->id); ?>" class="form-label">Đơn hàng tối thiểu được áp dụng</label>
                                                                                                <input type="number" class="form-control" id="min_order-<?php echo e($voucherMain->id); ?>" name="min_order" min="1"
                                                                                                    placeholder="Đơn hàng tối thiểu" value="<?php echo e(old('min_order', $voucherMain->min_order)); ?>" required
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <input type="text" class="form-control" id="code-<?php echo e($voucherMain->id); ?>" name="code"
                                                                                                    placeholder="Mã giảm giá" value="<?php echo e(old('code', $voucherMain->code)); ?>" required
                                                                                        ...
                                                                                        <div class="col-6">
                                                                                            <div class="mb-3">
                                                                                                ...
                                                                                                <select style="width: 130px" class="form-control" id="status-<?php echo e($voucherMain->id); ?>" name="status" required
                                                                                                    title="Vui lòng chọn trạng thái.">
                                                                                                    <option value="" disabled>Chọn trạng thái</option>
                                                                                                    <option value="2" <?php echo e(old('status', $voucherMain->status) == 2 ? 'selected' : ''); ?>>Hoạt động</option>
                                                                                                    <option value="0" <?php echo e(old('status', $voucherMain->status) == 0 ? 'selected' : ''); ?>>Không hoạt động</option>
                                                                                                </select>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="col-lg-12">
                                ...
                                <div class="mt-3">
                                    <?php echo e($voucherMains->appends(['token' => auth()->user()->refesh_token])->links()); ?>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-3">
                                    <?php echo e($inactiveVoucher->appends(['token' => auth()->user()->refesh_token])->links()); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\vnshop.top\resources\views/voucher/voucher_list.blade.php ENDPATH**/ ?>