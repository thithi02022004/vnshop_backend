        ...
        <div class="modal-content">
            <div class="modal-body text-center p-5">
                <lord-icon
                    ...
                    <form action="<?php echo e(route('delete_all', ['token' => auth()->user()->refesh_token])); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="mt-4">
        ...
        <div class="modal-content">
            <div class="modal-body text-center p-5">
                <lord-icon
                    ...
                    <form action="<?php echo e(route('delete_data_by_date', ['token' => auth()->user()->refesh_token])); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="mt-4">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn_1\resources\views/setting_admin/setting_admin.blade.php ENDPATH**/ ?>