    ...
    <div class="container-fluid">
        <div class="row">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <button class="nav-link <?php echo e($tab == 1 ? 'active' : ''); ?>" id="nav-home-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="<?php echo e($tab == 1 ? 'true' : 'false'); ?>">Tất cả</button>
                    <button class="nav-link <?php echo e($tab == 2 ? 'active' : ''); ?>" id="nav-profile-tab" data-bs-toggle="tab"
                        data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile"
                        aria-selected="<?php echo e($tab == 2 ? 'true' : 'false'); ?>">Đã xóa</button>
                </div>
            </nav>
            <div class="tab-content" id="nav-tabContent">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-body text-center p-5">
                                                <form id="addBlogForm"
                                                    action="<?php echo e(route('blogs.store', [
                                        ...
                                        <table id="blogallnew" class="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <th scope="row"><a href="#"
                                                                class="fw-medium"><?php echo e($blog->id); ?></a></th>
                                                        <td
                                                            style="max-width: 150px; white-space: normal; overflow: hidden; text-overflow: ellipsis;">
                                                            <?php echo e($blog->name); ?></td>
                                                        <td
                                                            style="max-width: 150px; white-space: normal; overflow: hidden; text-overflow: ellipsis;">
                                                            <?php echo e($blog->slug); ?></td>
                                                        <td
                                                            style="max-width: 150px; white-space: normal; overflow: hidden; text-overflow: ellipsis;">
                                                            <?php echo e($blog->title); ?></td>
                                                        <td
                                                            style="max-width: 150px; white-space: normal; overflow: hidden; text-overflow: ellipsis;">
                                                            <?php echo e($blog->user->fullname); ?></td>
                                                        <td>

                                                            <a href="#" data-bs-toggle="modal"
                                                                data-bs-target="#editModal-<?php echo e($blog->id); ?>">
                                                            ...
                                                            <!-- Modal Chỉnh sửa -->
                                                            <div class="modal fade" id="editModal-<?php echo e($blog->id); ?>"
                                                                tabindex="-1"
                                                                aria-labelledby="editModalLabel-<?php echo e($blog->id); ?>"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="editModalLabel-<?php echo e($blog->id); ?>">
                                                                                Chỉnh sửa Blog</h5>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form
                                                                                action="<?php echo e(route('blogs.update', [
                                                                                    'id' => $blog->id,
                                                                                    'tab' => 1,
                                                                                    'token' => auth()->user()->refesh_token,
                                                                                ])); ?>"
                                                                                ...
                                                                                <!-- Tiêu đề -->
                                                                                <div class="mb-3">
                                                                                    <label for="title-<?php echo e($blog->id); ?>"
                                                                                        class="form-label">Tên Blog</label>
                                                                                    <input type="text" name="name"
                                                                                        id="title-<?php echo e($blog->id); ?>"
                                                                                        class="form-control"
                                                                                        value="<?php echo e($blog->name); ?>"
                                                                                        required>
                                                                                </div>
                                                                                <!-- Nội dung -->
                                                                                <div class="mb-3">
                                                                                    <label
                                                                                        for="content-<?php echo e($blog->id); ?>"
                                                                                        class="form-label">Nội
                                                                                        dung:</label>
                                                                                    <textarea name="title" id="content-<?php echo e($blog->id); ?>" class="form-control" rows="4" required><?php echo e($blog->title); ?></textarea>
                                                                                </div>
                                                                                <button type="submit"
                                                            ...
                                                            <form
                                                                action="<?php echo e(route('blogs.destroy', [
                                                                    'token' => auth()->user()->refesh_token,
                                                                    'id' => $blog->id,
                                                                    'tab' => 1,
                                                                ])); ?>"
                ...
                <div class="tab-pane fade <?php echo e($tab == 2 ? 'show active' : ''); ?>" id="nav-profile" role="tabpanel"
                                    ...
                                    <div class="table-responsive">
                                        <table id="blogalldelete" class="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $deletedBlog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <th scope="row"><a href="#"
                                                                class="fw-medium"><?php echo e($blog->id); ?></a></th>
                                                        <td
                                                        ...
                                                        <td>
                                                            <form
                                                                action="<?php echo e(route('blogs.restore', [
                                                                    'token' => auth()->user()->refesh_token,
                                                                    'id' => $blog->id,
                                                                    'tab' => 2,
                                                                ])); ?>"
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\datn_1\resources\views/blogs/blogs.blade.php ENDPATH**/ ?>