                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = $mergedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($product->shop->shop_name ?? "Không có tên"); ?></td> 
                                                    <td>
                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = $pendingProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($product->sku); ?></td>
                                                    <td><?php echo e(number_format($product->price, 0, ',', '.')); ?> VNĐ</td>
                                                    <td style="word-wrap: break-word; white-space: normal; max-width: 50px;" ><?php echo e($product->shop->shop_name ?? "Không có tên"); ?></td> 
                                                    <td>
                                                        <?php if($product->status == 3): ?>
                                                        Chưa duyệt
                                                    <?php endif; ?>
                                                                            ...
                                                                            <div class="card-body">
                                                                              <div class="mb-5 d-flex">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        <div class="mb-3">
                                                                                            <strong>Tên Shop</strong> <span class="text-muted"><?php echo e($product->shop->shop_name ?? "Không có tên"); ?></span>
                                                                                        </div>
                                                                                        <div class="mb-3">
                                                                              ...
                                                                              <div class="mb-5 d-flex">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-lg-6">
                                                                                        ...
                                                                                        <div class="mb-3 d-flex ">
                                                                                            <strong>Tên sản phẩm: </strong> <span class="text-muted" style="word-wrap: break-word; white-space: normal; max-width: 200px;"><?php echo e($product->name); ?></span>
                                                                                        </div>
                                        ...
                                        <?php else: ?>
                                            <?php $__currentLoopData = $violatingProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td> 
                                                        sản phẩm vi phạm <br>
                                                        <span style="color:red">Lý do</span>: <?php echo e($product->admin_note); ?> 
                                                    <td><?php echo e($product->created_at); ?></td>
                                                    <td>
                                                        <!-- Duyệt -->
                                                        <form action="<?php echo e(route( 'products.approve' ,[
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\vnshop.top\resources\views/products/list_product.blade.php ENDPATH**/ ?>