                ...
                <table width="600px" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="background-color: #2684e3d3; padding: 20px; text-align: center;">
                            <h1 style="color: #ffffff; margin: 0;"><?php echo e($eventTitle ?? "Sự kiện đặc biệt"); ?></h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 20px; text-align: left;">
                            <h2 style="color: #333333; margin-bottom: 10px;">Kính gửi <?php echo e($user->fullname ?? "Bạn"); ?>,</h2>
                            <p style="color: #555555; line-height: 1.6; font-size: 16px;">
                                Chúng tôi rất vui mừng thông báo bạn đã nhận được một mã voucher đặc biệt:
                            </p>
                            <p style="font-size: 18px; font-weight: bold; color: #e74c3c;">MÃ VOUCHER: <?php echo e($code); ?></p>
                            <p style="color: #555555; line-height: 1.6; font-size: 16px;">
...
<?php /**PATH D:\laragon\www\vnshop.top\resources\views/emails/mail_event.blade.php ENDPATH**/ ?>