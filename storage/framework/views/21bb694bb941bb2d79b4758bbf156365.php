                    ...
                    <ul style="list-style: none; padding: 0; margin: 0;">
                            ...
                            <?php if($orderDetail->order_id == $order->id): ?>
                                <?php if(!$orderDetail->variant_id ): ?>
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($orderDetail->product_id == $product->id): ?>
                                            ...
                                            <div>
                                                <div>Tên sản phẩm:<?php echo e(\Illuminate\Support\Str::words($product->name ?? '', 7, '...')); ?> </div>
                                                <div>Số lượng: <?php echo e($orderDetail->quantity ?? null); ?></div>
                                            </div>
                                            <div class="p-2">
                                ...
                                <?php else: ?> 
                                    <?php $__currentLoopData = $variants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($orderDetail->variant_id == $variant->id): ?>
                                            <li style="display: flex; justify-content: space-between; align-items: center; padding: 10px 0; border-bottom: 1px solid #ddd;">
                                                <span>
                                                    <img src="<?php echo e($variant->images ?? null); ?>" alt="" style="width: 110px; height: 80px; padding-right: 10px;">
                                                </span>
                                                <div>
                                                <div> Tên sản phẩm:<?php echo e(\Illuminate\Support\Str::words($variant->product->name ?? '', 7, '...')); ?></div>
                                            <div>Số Lượng: <?php echo e($orderDetail->quantity ?? null); ?></div>
                                                <div>Phân loại: <?php echo e($variant->name); ?></div>
                                                </div>
                                                <div class="p-2">
                                                    <span style="font-weight: bold;"><?php echo e(number_format($orderDetail->subtotal ?? 0)); ?> đ</span>
                                                </div>
                        ...
                        <div style="border-top: 1px solid #ddd; padding-top: 15px; margin-top: 15px;">
                            <p style="margin: 0 0 10px;">Tổng tiền hàng:
                                <span style="font-weight: bold;"><?php echo e(number_format($order->price_before_vat)); ?>đ</span>
                            </p>
    ...
    </html><?php /**PATH D:\laragon\www\vnshop.top\resources\views/emails/confirm_oder_tocart.blade.php ENDPATH**/ ?>